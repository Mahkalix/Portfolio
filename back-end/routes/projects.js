...
const getProjectById = async (req, res, prisma) => {
  const { id } = req.params;
...
const getProjects = async (req, res, prisma) => {
  try {
...
// Ajouter un projet
const addProject = async (req, res, prisma) => {
...
const updateProject = async (req, res, prisma) => {
  const { id } = req.params;
  const { title, description, year, use, visit, view, cover, tools, category } = req.body;
...
// Supprimer un projet
const deleteProject = async (req, res, prisma) => {
  const { id } = req.params;
